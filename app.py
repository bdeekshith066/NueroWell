...
if st.session_state.user_info is None:
    ...
    with col5:
        st.write('')
        st.write('')
        components.html(get_slideshow_html(), height=300, width=400)
        typing_animation = """
